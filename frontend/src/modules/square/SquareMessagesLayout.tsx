...
export function SquareMessagesLayout({ conversationId }: Props) {
  return (
    <SquareCommunityLayout section="messages" wideMain lockMainHeight>
      <div className="flex h-[min(640px,calc(100dvh-11rem))] max-h-[calc(100dvh-11rem)] flex-col overflow-hidden rounded-2xl border border-kc-border bg-kc-surface/60 shadow-kc-glow md:flex-row">
        <aside className="hidden h-full min-h-0 w-56 shrink-0 flex-col border-r border-kc-border md:flex lg:w-64 xl:w-72">
